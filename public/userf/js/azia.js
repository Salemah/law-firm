$(function(){
  ...
  function appendBanner() {
    ...
    if ($.cookie('azia-free-banner')!="true") {
      ...
      $("body").prepend('\
        <div class= "item-purchase-banner">\
          <p class="banner-text">Free 24/7 customer support, updates, and more with this template!</p>\
            <a href="https://www.bootstrapdash.com/product/azia-admin/?utm_source=organic&utm_medium=banner&utm_campaign=getpro" target="_blank" class= "banner-button btn btn-primary text-primary btn-icon wd-100">\
             Get Pro\
            </a>\
            <a href="https://www.bootstrapdash.com/product/azia-admin/" class="text-white ml-auto tx-20"><i class="typcn typcn-home"></i></span></a>\
            <span class="toggler-close tx-20"><i class="typcn icon typcn-delete-outline"></i></span>\
        </div>\
      ')
      $(".item-purchase-banner .toggler-close").on("click", function () {
        ...
        $.cookie('azia-free-banner', "true", { expires: date });
