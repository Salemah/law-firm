  <footer class="main-footer">
            ...
            &copy; 2024 <a href="https://www.multipurposethemes.com/">SatIt</a>. All Rights Reserved.
        </footer>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="control-sidebar-settings-tab">
                    <div class="media-list media-list-hover media-list-divided">
                        <div class="media">
                            <img class="avatar avatar-lg" src="{{ asset('userf/images/avatar/1.jpg') }}"
                                alt="...">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media-block-actions">
                                    ...
                                    <nav class="nav no-gutters gap-2 font-size-16 media-hover-show">
                                        <a class="nav-link text-success" href="#" data-toggle="tooltip"
                                            title="" data-original-title="Approve"><i
                                                class="ion-checkmark"></i></a>
                                        <a class="nav-link text-danger" href="#" data-toggle="tooltip"
                        ...
                        <div class="media">
                            <img class="avatar avatar-lg" src="{{ asset('userf/images/avatar/2.jpg') }}"
                                alt="...">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media-block-actions">
                                    <nav class="nav nav-dot-separated no-gutters">
                                        ...
                                        <div class="nav-item">
                                            <a class="nav-link text-danger" href="#"><i
                                                    class="fa fa-thumbs-down"></i> (23)</a>
                                        </div>
                                    </nav>
