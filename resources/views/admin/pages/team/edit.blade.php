...
@section('content')
    <div class="">
        ...
        <form action="{{ route('admin.team.update',$team->id) }}" enctype="multipart/form-data" method="team">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-12  col-md-6 mb-2">
                                    ...
                                    <input type="file" id="image" data-default-file="{{ asset('image/team/' . $team->image) }}" data-height="290"class="dropify form-control @error('image') is-invalid @enderror" name="image">
                                    @error('image')
