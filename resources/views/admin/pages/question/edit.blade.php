                       ...
                       <div class="row">
                               <div class="form-group col-12 col-sm-12 col-md-12 mb-2">
                                   <label for="question"><b>Question Name</b><span class="text-danger">*</span></label>
                                       ...
                                       <textarea  class="form-control " placeholder="Enter  Question Name"  name="question" id="question" cols="30" rows="5">{{$question->question}}</textarea>
                                   @error('question')
                               ...
                               <div class="form-group col-12 col-sm-12 col-md-12 mb-2">
                                  ...
                                  <textarea name="answer" class="form-control " placeholder="Enter  Answer"  id="answer" cols="30" rows="5"> {{$question->answer}}</textarea>
                                   @error('question')
                                       <span class="alert text-danger" role="alert">
                                           <strong>{{ $message }}</strong>
                                       </span>
