                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a class="btn btn-sm btn-success text-white"
                                href="{{ route('admin.sublegalarea.index') }}">
...
@section('content')
    <div class="">
        ...
        <form action="{{ route('admin.sublegalarea.update', $post->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    <label for="title"><b>Name</b><span class="text-danger">*</span></label>
                                    <select name="legal_area_id" id="legalarea"
                                        class="custom-select @error('legalarea') is-invalid @enderror">
                                        <option value="">--Select Legal Area--</option>
                                        @foreach ($legalareas as $legalarea)
                                            <option value="{{ $legalarea->id }}"
                                                @if ($legalarea->id == $post->legal_area_id) selected @endif>{{ $legalarea->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('title')
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    ...
                                    <input type="text" name="icon" id="icon"
                                        class="form-control @error('icon') is-invalid @enderror" value="{{ $post->icon }}"
