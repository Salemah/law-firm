                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12  col-md-6 mb-2">
                                    ...
                                    <input type="file" id="image"
                                        data-default-file="{{ asset('image/user/' . $user->image) }}"
                            ...
                            <input type="text" name="facebook" id="facebook"
                                ...
                                value="{{ isset($user) ? $user->facebook : old('facebook') }} "
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                            ...
                            <input type="text" name="twitter" id="twitter"
                                ...
                                value="{{ isset($user) ? $user->twitter : old('twitter') }} "
                                placeholder="Enter System Title">
                            @error('twitter')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            @enderror
                                ...
                                <div class="form-group col-12 mb-2">
                                    ...
                                    <textarea name="description" id="description" rows="10" cols="40"
                                        class="form-control @error('description') is-invalid @enderror" placeholder="Description..."> {{ $user->description }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
