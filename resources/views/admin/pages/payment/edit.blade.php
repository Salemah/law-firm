...
@section('content')
    <div class="">
        ...
        <form action="{{ route('admin.payment.update',$payment->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="form-control @error('name') is-invalid @enderror" value="{{$payment->name}}"
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    ...
                                    <input type="text" name="account_no" id="account_no"
                                        ...
                                        value="{{$payment->account_no}}" placeholder="Enter account_no">
                                    @error('account_no')
                                        <span class="alert text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    ...
                                    <input type="text" name="type" id="type"
                                        ...
                                        value="{{$payment->type}}" placeholder="Enter Type">
                                    @error('type')
                                        <span class="alert text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    ...
                                    <input type="text" name="branch" id="branch"
                                        ...
                                        value="{{$payment->branch}}" placeholder="Enter Branch">
                                    @error('branch')
                                        <span class="alert text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                 ...
                                 <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    ...
                                    <input type="text" name="routing_no" id="routing_no"
                                        ...
                                        value="{{$payment->routing_no}}" placeholder="Enter Routing No">
                                    @error('routing_no')
                                        <span class="alert text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
