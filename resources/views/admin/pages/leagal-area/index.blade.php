                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a class="btn btn-sm btn-success text-white"
                                href="{{ route('admin.legalarea.create') }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.legalarea.index') }}",
                    type: "get"
                },
                columns: [{
                        data: "DT_RowIndex",
        ...
        function deleteItem(id) {
            var url = '{{ route('admin.legalarea.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
        ...
        function statusChange(id) {
            var url = '{{ route('admin.leagal-area.update.status', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function(resp) {
