...
@section('content')
    <div class="">
        ...
        <form action="{{ route('admin.case.update', $post->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="form-group col-12  col-md-6 mb-2">
                                    ...
                                    <input type="file" id="image"
                                        data-default-file="{{ asset('image/case/' . $post->image) }}"
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    <label for="category"><b>Legal Area</b><span class="text-danger">*</span></label>
                                    <select name="category" id="category"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                ...
                                                {{ $post->legal_area_id == $category->id ? 'selected' : '' }}
                                               >
