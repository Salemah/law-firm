...
@section('content')
    <div class="">
        ...
        <form action="{{ route('admin.company.update', $Company->id) }}" enctype="multipart/form-data" method="Company">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="form-group col-12  col-md-6 mb-2">
                                    ...
                                    <input type="file" id="image"
                                        data-default-file="{{ asset('image/company/' . $Company->image) }}"
                                ...
                                <div class="form-group col-12 mb-2">
                                    ...
                                    <textarea name="description" id="description" rows="10" cols="40"
                                        class="form-control @error('description') is-invalid @enderror" placeholder="Description..."> {{ $Company->description }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
